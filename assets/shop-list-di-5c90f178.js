import{a as p,b as d,c as h,N as g}from"./backdrop-heart-e2af3691.js";const m=new g,e=document.querySelector(".shop-list"),a=document.querySelector(".shop-background");console.log(a);const k=async s=>{for(const o of s){const t=await m.fetchBooksForId(o);Array.isArray(t)?t.forEach(i=>{l(i)}):l(t)}},l=s=>{a.innerHTML="";const o=`
